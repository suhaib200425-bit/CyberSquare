...
export default function HeroSectionTwo({
    titleOne = { value: "Our Program is <br /> designed to help <br />" },
    titleTwo = { value: "Change Starts <br /> With You" },
    subTitle ={value:"An online education program for those charged with domestic violence offences — built by lawyers, designed for real and lasting change."},
   gradientColors= {
      "type": "array",
      "value": [
        "#ff416c",
  ...
  ${gradientColors.value[2]} 100%)`
        ...
        VERSION 4 — FRIENDLY & ILLUSTRATED
          ...
          🎓 Online · Self-Paced · $220
                ...
                <h1
                    dangerouslySetInnerHTML={{ __html: titleOne.value }}
                    className="text-[72px] leading-[1.08] text-[#102b5c] font-black mb-6 max-md:text-[48px] max-[500px]:text-[38px]">

                </h1>

                <span className="font-medium text-[72px] leading-[1.08]  max-[500px]:text-[38px]  max-md:text-[48px] text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.15)]"
                    dangerouslySetInnerHTML={{ __html: titleTwo.value }}>
