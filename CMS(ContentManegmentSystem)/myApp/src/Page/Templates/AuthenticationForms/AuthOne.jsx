...
export default function AuthOne({
    ...
    // const { SetUser } = useStore(); // Zustand or context use cheyyunnuvenkil uncomment cheyyuka
    ...
    const handleOtpSubmit = async () => {
        ...
        try {
            ...
            setLoading(false);
            setIsRegister(false);
            setScreenOTP(true); // OTP success aayal thirich registration/login screen-lekk povaan
        } catch (error) {
                            ...
                            screenOTP ? (
                                <form className='w-full' onSubmit={handleSubmit}>
                                    ...
                                    <div className='flex gap-[20px] mt-[20px]'>
                                        ...
                                        >
                                            {Loading ? 'Processing...' : (isRegister ? 'Submit' : 'Log In')}
                                        </button>
                                    </div>
                                </form>
                            ) : (
                                <div className="flex flex-col items-start gap-4 mt-10">
                                    ...
                                    <button
                                        ...
                                        className="px-5 py-3 rounded-[10px] cursor-pointer"
                                    >
