...
import PostCreateAndUpdateForm from '../../components/PostCreateAndUpdateForm/PostCreateAndUpdateForm';
function FormPage({formname,setForm,update}) {

  // const { formname } = useParams();
  const forms={
    'menu':<MenuForm setFormClose={setForm} update={update}/>,
    'post':<PostCreateAndUpdateForm  setFormClose={setForm} update={update}  />,
