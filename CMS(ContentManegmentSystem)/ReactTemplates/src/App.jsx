...
const fieldClass =
  'w-full rounded-[7px] border border-[#3b424b] bg-[#151a1f] px-4 py-2.5 text-[15px] text-[#e7e7e7] outline-none transition placeholder:text-[#68707b] focus:border-[#2dbfd2] focus:ring-2 focus:ring-[#2dbfd2]/25'
...
function PostDetailsCard({ title, onTitleChange, onBannerClick }) {
  return (
    <Card title="Post Details" className="min-h-[402px]">
      ...
      <button
        ...
        className="mt-5 flex h-[216px] w-full flex-col items-center justify-center rounded-[10px] border border-dashed border-[#8f98a6] bg-[#262a2f] text-center transition hover:border-[#3ac7d8] hover:bg-[#2a3036] focus:outline-none focus:ring-2 focus:ring-[#38c6d8]/35"
      >
    ...
    <Card title="Publishing Info" className="min-h-[402px]">
      <div className="space-y-5">
        <SelectField
          ...
          options={['Choose', 'News', 'Lifestyle', 'Opinion', 'Culture']}
        />
        <SelectField
          label="Status"
          value={status}
        ...
        <div>
          ...
          <textarea
            ...
            className={`${fieldClass} h-[103px] resize-none`}
          />
        </div>
      </div>
    </Card>
...
function NewPostPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0f1011] font-sans text-[#eeeeee]">
      {/* <AppHeader /> */}

      <div className="mx-auto max-w-[1238px] px-8 pb-10 pt-7">
        <h1 className="mb-8 text-[30px] font-semibold leading-none text-[#dedede]">New Post</h1>
      ...
      <input
        ...
        onChange={(event) => {
          ...
          if (selectedFile) {
            console.log('Selected banner image:', selectedFile.name)
          }
        }}
      />
    </main>
